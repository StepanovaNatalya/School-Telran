...
import { registration } from '../store/users/actionCreator'

const Registartion = ({ registrationUser, error, currentUser }) => {
...
const mapDispatchToProps = dispatch => {
    return {
        registrationUser: (user) => dispatch(registration(user))
    }
}
